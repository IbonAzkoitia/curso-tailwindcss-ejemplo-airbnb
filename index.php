...
<!-- Mapa -->
<div class="lg:hidden fixed w-full flex justify-center z-50 bottom-20"
     x-show="map"
...
<!-- Footer Nav -->
<div class="lg:hidden fixed w-full py-3 border-t border-gray-300 bg-white flex justify-center items-center gap-8 bottom-0 z-50 transition duration-500"
     x-show="menu"
     x-transition:enter="transition ease-out duration-300"
