...
<div class="relative z-10" aria-labelledby="modal-title" role="dialog" aria-modal="true"
	...
	<!--
	  ...
	  Leaving: "ease-in duration-200"
		...
		To: "opacity-0"
	-->
	<div class="fixed inset-0 bg-[#7e7e7e] transition-opacity"></div>

	<div class="fixed inset-0 z-10 w-screen" style="overflow:clip;">
		<div class="relative flex min-h-full items-end justify-center pt-3 text-center sm:items-center sm:p-0">
			<!--
			...
			-->
			<div class="relative w-full flex flex-col transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-sm sm:p-6" style="">
				...
				<div class="max-h-[700px] overflow-y-auto">
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div x-data="{serviciosOcultos: false, text: 'Mostrar más'}">
                            <div x-show="serviciosOcultos" class="space-y-4">
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div x-data="{idiomasOcultos: false, text: 'Mostrar más'}">
                            <div x-show="idiomasOcultos" class="space-y-4">
